...
internal class Boss_Fight_Thunderer(Game game) : ChallengeScene(game)
{
    ...
    protected override void AddJsonLevels()
    {
        ...
        // 1.) Burner
        string jsonFilePath = Path.Combine("..", "..", "..", "Scripts", "Serialization", "JsonFiles", "JSON_challenge7.json");
