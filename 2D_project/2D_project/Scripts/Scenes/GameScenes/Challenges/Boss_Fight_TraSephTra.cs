...
internal class Boss_Fight_TraSephTra(Game game) : ChallengeScene(game)
{
    protected override void InitializeContent()
    {
        ...
        challengeData = ExisitingPlayerSessions.GetActiveSession().Challenges[6];

        // TESTING
        SoundController.instance.PlayMusic(GameConstantsAndValues.FactionType.Thunderer.ToString(), isRepeating: true);
    ...
    protected override void AddJsonLevels()
    {
        ...
        // 1.) Burner
        string jsonFilePath = Path.Combine("..", "..", "..", "Scripts", "Serialization", "JsonFiles", "JSON_challenge8.json");
